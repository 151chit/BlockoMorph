...
@Mod("blockomorph")
public class BlockomorphMod {
	public static final Logger LOGGER = LogManager.getLogger(BlockomorphMod.class);
	public static final String MODID = "blockomorph";

	public BlockomorphMod(IEventBus modEventBus) {
	...
	() -> new TestBl(BlockBehaviour.Properties.of().noLootTable().setId(ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(MODID, "example_block")))));
	*/
