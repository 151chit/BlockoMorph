...
public class ScrollerManager<T> {
	private static final Identifier SCROLLER_SPRITE = GuiUtils.vanillaRes("container/creative_inventory/scroller");
	private static final Identifier SCROLLER_DISABLED_SPRITE = GuiUtils.vanillaRes("container/creative_inventory/scroller_disabled");
	...
	public record CustomBarData(Identifier barSprite, int barLength, int barHeight) {
	}
}
