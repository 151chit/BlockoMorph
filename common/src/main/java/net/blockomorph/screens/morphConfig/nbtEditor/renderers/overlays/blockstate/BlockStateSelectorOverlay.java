...
public class BlockStateSelectorOverlay extends TagEditingOverlay {
	...
	private int leftPos;
	private int topPos;
	private static final Identifier MENU = GuiUtils.res("textures/screens/state_selector.png");
	...
	public boolean mouseClicked(MouseButtonEvent mouseButtonEvent, boolean doubleClick) {
		if (mouseButtonEvent.button() == 0) {
			...
			return this.propsRenderer.mouseClicked(mouseButtonEvent.x(), mouseButtonEvent.y(), mouseButtonEvent.button());
		}
		return false;
	}
