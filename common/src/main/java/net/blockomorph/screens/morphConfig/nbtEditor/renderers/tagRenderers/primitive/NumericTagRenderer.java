...
public abstract class NumericTagRenderer<NUMBER_TAG extends NumericTag> extends PrimitiveTagRenderer<NUMBER_TAG> {
	public static final int INT_COLOR = ARGB.color(255, 89, 47, 245);
	public static final int LONG_COLOR = ARGB.color(255, 0, 137, 158);
	public static final int DOUBLE_COLOR = ARGB.color(255, 27, 206, 62);
	public static final int FLOAT_COLOR = ARGB.color(255, 250, 202, 32);
	public static final int SHORT_COLOR = ARGB.color(255, 173, 0, 184);
	public static final int BYTE_COLOR = ARGB.color(255, 178, 0, 20);
