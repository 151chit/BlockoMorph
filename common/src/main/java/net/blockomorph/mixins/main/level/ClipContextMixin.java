...
public class ClipContextMixin implements ClipContextAccessor {
	...
	@Mutable @Shadow @Final private CollisionContext collisionContext;
	...
	public ClipContext.Fluid getFluidMode() {
		return this.fluid;
	}

	public ClipContext normalize() {
		return new ClipContext(InPlayerBlockPos.checkOnReal(this.from), InPlayerBlockPos.checkOnReal(this.to), this.block, this.fluid, this.collisionContext instanceof EntityCollisionContext c ? c.getEntity() : null);
	}
}
