...
public class Vec3Mixin {
	...
	public double getRealCoords(double original, Vec3 vec3) {
		return MorphDistanceTo.forPoints(original, vec3, (Vec3) (Object) this, false, 0);
	}
	...
	public double getRealCoordsSqr(double original, Vec3 vec3) {
		return MorphDistanceTo.forPoints(original, vec3, (Vec3) (Object) this, true, 0);
	}
	...
	public double getRealCoordsSqrDDD(double original, double x, double y, double z) {
		return MorphDistanceTo.forPoints(original, (Vec3) (Object) this, x, y, z, true, 0);
	}
}