...
public class ServerCommonListener {
	...
	@FastInject(method = "send(Lnet/minecraft/network/protocol/Packet;Lnet/minecraft/network/PacketSendListener;)V", at = @At("HEAD"))
	private boolean bypassNeoforge(Packet<?> packet, @Nullable PacketSendListener listener) {
