...
public class SuffOverlayScreenEffectRendererMixin {
	...
	private void handle(boolean isFirstPerson, float deltaTick, SubmitNodeCollector submitNodeCollector, Operation<Void> original) {
		...
		try {
			original.call(isFirstPerson, deltaTick, submitNodeCollector);
		} finally {
