...
public class ShadowsMixin {//isBlockomorphActive();
	...
	private static boolean suppress(PoseStack poseStack, MultiBufferSource multiBufferSource, EntityRenderState entityRenderState, float f, float g, LevelReader levelReader, float h) {
