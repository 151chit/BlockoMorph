...
public class SavedBlock {
	...
	public static SavedBlock fromTag(CompoundTag tag, String k) {
		CompoundTag nbt = tag.getCompoundOrEmpty("Tag");
		BlockState state = NbtUtils.readBlockState(Minecraft.getInstance().level.holderLookup(Registries.BLOCK), tag.getCompoundOrEmpty("BlockState"));
