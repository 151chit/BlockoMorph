...
public class DamageTypeIdsConfig extends RegistryMapIdsConfig<Integer, DamageType> {
	private static final Map.Entry<Set<Identifier>, Boolean> SPECIAL_DAMAGES =
			Map.entry(Set.of(DamageHandler.PLAYER_DESTROYED.identifier(), DamageHandler.PLAYER_DESTROYED_NULL.identifier()), true);
	private static final RegistryMapOptionContext CONTEXT = new RegistryMapOptionContext(true, SPECIAL_DAMAGES, SPECIAL_DAMAGES);
	private static DamageSourceOptionRenderer RENDERER;
	public DamageTypeIdsConfig(String name, Map<Identifier, Integer> initialValue, boolean canOperatorModify, @Nullable Component tip) {
