...
public class ConfigStorage {
	...
	public final DamageTypeIdsConfig allowedDamages = new DamageTypeIdsConfig("allowedDamages", new HashMap<>(
			Map.of(DamageTypes.GENERIC_KILL.identifier(), -1, DamageTypes.FELL_OUT_OF_WORLD.identifier(), -1,
					DamageTypes.PLAYER_EXPLOSION.identifier(), -1, DamageTypes.EXPLOSION.identifier(), -1,
					DamageTypes.BAD_RESPAWN_POINT.identifier(), -1)),
			true, null);
